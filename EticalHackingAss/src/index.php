...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // OWASP Password Storage Cheat Sheet: fetch the user record and verify the bcrypt hash with password_verify().
    ...
    if ($stmt) {
        ...
        if ($result && $result->num_rows > 0) {
            ...
            if (password_verify($password, $candidate_user['password'])) {
                $logged_in_user = $candidate_user;
        ...
        $login_error = "Database Error: Unable to prepare login query.";
    }
}
?>
<!DOCTYPE html>
    ...
    <div class="flex-grow-1">
        ...
        <div class="container">
            <div class="row">
                ...
                <!-- Right Column: Support & Assistance -->
                <div class="col-md-6 mb-4">
