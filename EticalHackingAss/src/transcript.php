...
// PHP Session Check: Ensure student_id is set in the URL search query, otherwise redirect
...
<body class="d-flex flex-column min-vh-100">
                ...
                <div class="col-md-9 col-lg-10 py-4 px-4 bg-light">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-9 col-lg-11 col-md-12">
                            ...
                            <!-- Academic Transcript Card (Blue Header) -->
    ...
    <!-- Background API Fetch logic -->
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            // READ FROM BROWSER QUERY STRING (facilitates IDOR demonstration by changing URL in address bar)
            ...
            // Fetch grades dynamically from REST API using the ID parsed from URL query string
