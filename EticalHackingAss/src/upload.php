...
// 1. Validate file size and ensure a file was uploaded.
// 2. Validate file extension using an allowlist (e.g., pdf, docx, txt, zip).
// 3. Verify MIME type using Fileinfo to prevent extension spoofing.
// 4. Generate a random/unique filename to prevent path traversal/file overwriting.
// 5. Store files in a directory where script execution is disabled or outside the web root.
    ...
    if ($file['error'] !== UPLOAD_ERR_OK) {
        ...
        if (!in_array($file_ext, $allowed_exts)) {
            ...
            if (!in_array($mime_type, $allowed_mimes)) {
                ...
                // 3. Prevent executable storage and directory traversal
                // Generate a cryptographically secure random filename
                $new_filename = bin2hex(random_bytes(16)) . '.' . $file_ext;
                
                // Define destination directory (ideally outside the web root or strictly configured)
                ...
                <div class="col-md-9 col-lg-10 py-4 px-4 bg-light">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-8 col-lg-10 col-md-12">
                            ...
                            <!-- Upcoming Due Coursework Card (Slate-800) -->
                            ...
                            <!-- Assignment Submission Card (Red Header) -->
