...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // VULNERABLE SQL INJECTION QUERY: Constructing SQL raw input directly
    // This allows bypass using payloads like: admin' -- or ' OR '1'='1
    ...
    if ($result) {
        ...
        // Expose raw database error to assist the attacker/student in SQLi debugging
