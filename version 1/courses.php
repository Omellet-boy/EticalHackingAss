...
// Check if the courses table exists, otherwise use fallback mock data to prevent errors
$courses = [];
$table_exists = false;
...
if ($table_exists) {
    if ($search !== '') {
        // SECURE IMPLEMENTATION: Use prepared statements to prevent SQL Injection
    ...
    // Fallback Mock Data for demo purposes if the database table hasn't been migrated yet
    $all_mock_courses = [
                ...
                <div class="col-md-9 col-lg-10 py-4 px-4 bg-light">
                    ...
                    <?php if ($search !== ''): ?>
                        <div class="alert alert-info mb-4 py-2">
                            <!-- SECURE RENDER: HTML characters are escaped using htmlspecialchars() to block Reflected XSS -->
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card card-custom h-100 bg-white">
                                        ...
                                        <div class="card-body d-flex flex-column p-4">
                                            ...
                                            <!-- Enroll Now Button linking to payment page -->
                                            <div class="mt-auto">
