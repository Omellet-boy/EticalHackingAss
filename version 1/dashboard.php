...
// Ensure profile_pic column exists in users table safely
...
// Handler 1: Handle biography saving logic
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['save_bio'])) {
    $new_bio = $_POST['bio'] ?? '';

    // VULNERABLE UPDATE QUERY: Directly executing query containing raw data without sanitization or parameterization
...
// Handler 2: Handle Profile Picture upload logic
        ...
        if (!in_array($file_ext, $allowed_exts)) {
            ...
            if (!in_array($mime_type, $allowed_mimes)) {
                ...
                if (move_uploaded_file($file['tmp_name'], $destination)) {
                    // Update database securely using prepared statement
...
// Fetch latest user data from DB (bio and profile_pic)
...
// Coalescing operator fallback implementation to avoid undefined indices
                ...
                <div class="col-md-9 col-lg-10 py-4 px-4 bg-light">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <!-- Academic Dashboard (Blue Header) -->
                            ...
                            <!-- Academic Biography & Profile Picture (Purple Header) -->
                            <div class="card card-custom">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- Right Column: Biography Form (STORED XSS VULNERABILITY) -->
                                        <div class="col-md-8">
                                            <div class="p-3 mb-4 bg-light rounded border border-warning" style="min-height: 80px;">
                                                <strong>Current Bio:</strong><br>
                                                <?php 
                                                    // Directly outputting DB content without escaping htmlspecialchars (Stored XSS)
                                                    echo $user['bio']; 
                                                ?>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <!-- My Enrolled Courses (Teal Header) -->
                            <div class="card card-custom">
